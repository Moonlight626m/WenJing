...
DESCRIPTIONS: dict[str, str] = {
    "system": "角色定位与使命（system prompt 主体）",
    "checklist": "输出前自检清单",
    "evidence_policy": "可信度协议（来源×可信度、claims/conflicts 登记）",
    "structure_rules": "背景/时代/情节的结构维度（知人论世）",
    "persona_rules": "应试式人物形象分析维度",
    "scene_rules": "场景划分判据（价值转折/切换点）",
    "beat_rules": "节拍粒度判据（行为/反应交换）",
    "interaction_rules": "玩家介入点写法",
    "trait_rules": "性格标签「标签+证据+行为化」写作法",
    "speech_rules": "说话风格五要素与示例台词",
    "boundary_rules": "知识边界与禁编造约束",
    "playability_rules": "is_player_playable 判断准则",
    "procedure": "doubter 三段式审核流程",
    "baseline": "doubter 事实基准唯一性条款",
    "negative_list": "doubter 负面清单（禁风格意见）",
    "role": "编剧教学场景定位与红线",
    "dialogue_rules": "对白写作准则",
}
