...
用法::
    ...
    from app.errx import codes, new, wrap, match_code
...
from app.errx._factory import match_code, new, wrap
from app.errx._registry import (
    CodeDefinition,
    all_definitions,
    default_error_code,
    lookup,
...
from app.errx.error import Error
