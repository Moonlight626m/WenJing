...
| 固定扮演一个主角 | 多人联机（模型预留参与者） |
| 简单快照回溯（≤100 步） | 作品市场/社区化运营 |
| 编剧/验证/角色 Agent | 难度分级自适应 |
| **多用户账号 + 教师/学生 RBAC**（ADR-0002） | 班级/作业、内容审查 |
| **教师剧本库**（草稿→发布→下架，org/公网可见） | 账号改密/找回/验证 |
| **学生端**剧本广场 + 我的游戏 | 多组织、多人同世界 |
| **运营后台**（只读剧本库 + token 用量） | — |
| TTS/ASR 仅留接口 | — |
...
> 2026-09-15 ADR-0002 修订：**多用户账号、教师/学生 RBAC、教师剧本库与发布、
> 学生端游玩、只读运营后台**已纳入本轮范围；班级/作业、内容审查、多组织、
> 账号改密/找回/验证仍排除。
